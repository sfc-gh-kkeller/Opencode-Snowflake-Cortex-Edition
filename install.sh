...
Examples:
    ...
    curl -fsSL https://github.com/sfc-gh-kkeller/Opencode-Snowflake-Cortex-Edition/releases/latest/download/install.sh | bash -s -- --version 0.0.0
...
echo -e "https://github.com/sfc-gh-kkeller/Opencode-Snowflake-Cortex-Edition#snowflake-cortex-edition"
echo -e ""
echo -e ""
