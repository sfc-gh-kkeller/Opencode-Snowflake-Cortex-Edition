...
const TIPS = [
  "Snowflake Cortex quickstart: {highlight}cd <project>{/highlight} # Open directory, {highlight}opencode_cortex{/highlight} # Run command. Configure Cortex in opencode_cortex.json: https://github.com/sfc-gh-kkeller/Opencode-Snowflake-Cortex-Edition#snowflake-cortex-edition",
